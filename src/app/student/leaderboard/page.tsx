...
export default function StudentLeaderboard() {
  ...
  const [category, setCategory] = useState<"points" | "courses" | "hours">(
    "points",
  );
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex items-center space-x-4">
            <select
              ...
              onChange={(e) =>
                setTimeFrame(
                  e.target.value as "weekly" | "monthly" | "all-time",
                )
              }
            ...
            <select
              value={category}
              onChange={(e) =>
                setCategory(e.target.value as "points" | "courses" | "hours")
              }
              className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
            >
            ...
            >
              ...
              <div className="relative">
                <div className="w-20 h-20 mx-auto mb-4 relative">
                  ...
                  />
                  <div
                    className={`absolute -bottom-2 -right-2 w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold ${getRankBadgeColor(entry.rank)}`}
                  >
                    {entry.rank}
                  </div>
                </div>
