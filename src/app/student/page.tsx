          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100">
            ...
            <div className="p-6 space-y-4">
              {activeCourses.map((course) => (
                <div key={course.id} className="group border border-gray-200 rounded-lg p-4 hover:border-blue-200 hover:shadow-sm transition-all">
                ...
                return (
                  <div key={task.id} className="flex items-start space-x-3 p-3 rounded-lg hover:bg-gray-50 transition-colors">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-600 truncate">{task.course}</p>
