...
export default function StudentLayout({ children }: StudentLayoutProps) {
  ...
  useEffect(() => {
    ...
    const adminUser = typeof window !== 'undefined' ? sessionStorage.getItem('adminUser') : null;
    ...
    const isAuthCallback = window.location.pathname.includes('/api/auth/') || 
                          urlParams.has('code') || 
                          urlParams.has('state');
    
    if (isAuthCallback) {
      console.log("[StudentLayout] Authentication callback detected, waiting...");
