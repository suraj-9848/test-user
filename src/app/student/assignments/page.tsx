...
export default function StudentAssignments() {
  ...
  const [sortBy, setSortBy] = useState<"dueDate" | "status" | "course">(
    "dueDate",
  );
    ...
    const mockAssignments: Assignment[] = [
      {
        ...
        description:
          "Build a complete e-commerce website using React, Node.js, and MongoDB with user authentication, product catalog, shopping cart, and payment integration.",
      ...
      },
      {
        ...
        description:
          "Develop a machine learning model to predict house prices using various features. Include data preprocessing, feature engineering, model training, and evaluation.",
      ...
      },
      {
        ...
        description:
          "Design a complete mobile application interface for a fitness tracking app including wireframes, mockups, and interactive prototype.",
        ...
        score: 92,
        feedback:
          "Excellent design work! The user flow is intuitive and the visual hierarchy is well-executed. Minor suggestion: consider adding more micro-interactions to enhance user engagement.",
        attachments: [
          {
            id: "5",
      ...
      },
      {
        ...
        description:
          "Collaborate in teams to build a comprehensive analytics dashboard for social media metrics. Each team member should contribute to different components.",
        courseTitle: "Full Stack Web Development",
        courseId: "1",
        instructor: "Rajesh Kumar",
      ...
      },
      {
        ...
        description:
          "Design and implement a relational database for a library management system with proper normalization and indexing.",
        courseTitle: "Full Stack Web Development",
        courseId: "1",
        instructor: "Rajesh Kumar",
  ...
  const filteredAssignments = assignments.filter((assignment) => {
    const matchesSearch =
      ...
      assignment.topics.some((topic) =>
        topic.toLowerCase().includes(searchTerm.toLowerCase()),
      );
    const matchesStatus =
      filterStatus === "all" || assignment.status === filterStatus;
    const matchesCourse =
      filterCourse === "all" || assignment.courseId === filterCourse;
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      ...
      case "overdue":
        return (
          <span className="px-2 py-1 text-xs font-medium bg-red-100 text-red-700 rounded-full flex items-center">
  ...
  const uniqueCourses = [
    ...new Set(
      assignments.map((a) => ({ id: a.courseId, title: a.courseTitle })),
    ),
  ];
      ...
      <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
          ...
          <select
            value={sortBy}
            onChange={(e) =>
              setSortBy(e.target.value as "dueDate" | "status" | "course")
            }
            className="px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
          >
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <span
                        className={`px-2 py-1 text-xs font-medium rounded-full ${getDifficultyColor(assignment.difficulty)}`}
                      >
