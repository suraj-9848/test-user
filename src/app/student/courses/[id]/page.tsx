...
const CourseDetailPage = ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  const course = {
    ...
    progress: 65,
    description:
      "Master advanced React concepts including performance optimization, custom hooks, context API, and modern state management patterns.",
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <div className="prose max-w-none">
              <p className="text-gray-700 mb-4">
                This comprehensive course covers advanced React development
                techniques used in modern web applications. You&apos;ll learn to
                build scalable, performant React applications using the latest
