  ...
  const educationalFeatures = [
    {
      ...
      description: "Our adaptive learning system creates customized paths based on individual strengths, weaknesses, and learning pace.",
      icon: (
    ...
    },
    {
      ...
      description: "Engage with our interactive lessons, quizzes, simulations, and real-world projects that make learning practical and effective.",
      icon: (
    ...
    },
    {
      ...
      description: "Learn from industry practitioners and academic experts who bring real-world experience to their teaching.",
      icon: (
    ...
    },
    {
      ...
      description: "Monitor your learning journey with detailed analytics and progress reports that help you stay on track.",
      icon: (
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700">
            We combine cutting-edge technology with proven teaching methodologies to deliver an exceptional learning experience.
          </p>
        </div>
                  ...
                  <div className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-lg border border-green-100">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Course Completion Rate</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-6 rounded-lg border border-yellow-100">
                    <div className="flex items-center">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 font-medium">Average Student Satisfaction</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 shadow-lg border border-blue-100">
          <h3 className="text-2xl font-bold text-center text-gray-900 mb-8">Our Learning Framework</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-700 text-sm">Evaluate your current knowledge and skill level</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-700 text-sm">Tailor learning paths to your goals and needs</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-700 text-sm">Learn through interactive content and real-world projects</p>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-gray-700 text-sm">Demonstrate and apply your skills in real scenarios</p>
            </div>
          </div>
        </div>
      </div>
