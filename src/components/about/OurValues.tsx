  ...
  const values = [
    {
      title: "Excellence",
      description:
        "We strive for excellence in everything we do, from our curriculum to our student support.",
      color: "blue",
      icon: (
        <svg
    ...
    },
    {
      title: "Innovation",
      description:
        "We embrace innovation and continuously evolve our methods to stay ahead in a rapidly changing world.",
      color: "purple",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
    ...
    },
    {
      title: "Community",
      description:
        "We foster a supportive community where collaboration and mutual growth are encouraged.",
      color: "yellow",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          ...
          {values.map((value, index) => {
            ...
            return (
              ...
              >
                {/* Decorative circles */}
                <div
                  className={`absolute -top-4 -right-4 w-20 h-20 ${colorClasses.decorative} rounded-full opacity-50`}
                ></div>
                <div
                  className={`absolute -bottom-4 -left-4 w-16 h-16 ${colorClasses.decorative} rounded-full opacity-30`}
                ></div>
                ...
                <div className="relative z-10">
                  <div className="flex items-start space-x-5">
                    <div className="flex-shrink-0">
                      <div
                        className={`w-16 h-16 bg-gradient-to-br ${colorClasses.icon} rounded-full flex items-center justify-center shadow-lg`}
                      >
                        {value.icon}
                      </div>
                    </div>
            ...
            <div className="relative z-10 text-center">
              <div className="mb-6">
                ...
                <p className="text-blue-100 text-lg mb-8 max-w-2xl mx-auto">
                  Join thousands of students and professionals who share our
                  values and are building successful careers together.
                </p>
              </div>

              <Link
                href="https://chat.whatsapp.com/KuaphYb8hwiITWbp1bNtpo"
                target="_blank"
