...
export default function OurJourney() {
  ...
  return (
    <section
      id="our-journey"
      className="pt-24 pb-0 bg-white overflow-hidden relative"
    >
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700">
            From our founding to where we are today, every milestone has been
            guided by our commitment to empowering careers.
          </p>
        </div>
              ...
              {milestones.map((milestone, index) => (
                <div key={index} className="relative z-10">
                  ...
                  >
                    ...
                    <div
                      className={`mt-12 md:mt-0 ml-16 md:ml-0 md:w-5/12 ${index % 2 === 0 ? "md:mr-auto md:pr-8" : "md:ml-auto md:pl-8"}`}
                    >
                      <div className="relative group">
                        {/* Decorative elements around content */}
                        <div
                          className={`absolute -top-4 ${index % 2 === 0 ? "-right-4" : "-left-4"} w-16 h-16 bg-gradient-to-br from-blue-200 to-indigo-200 rounded-full opacity-50 group-hover:opacity-70 transition-opacity duration-300`}
                        ></div>
                        <div
                          className={`absolute -bottom-4 ${index % 2 === 0 ? "-left-4" : "-right-4"} w-12 h-12 bg-gradient-to-br from-purple-200 to-pink-200 rounded-full opacity-40 group-hover:opacity-60 transition-opacity duration-300`}
                        ></div>
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            <div className="mb-8">
              ...
              <p className="text-white/90 mb-8 max-w-3xl mx-auto text-xl leading-relaxed">
                As we look to the future, we remain committed to innovation and
                excellence in education. Our vision is to become the leading
                platform that connects learning with career success, empowering
                millions to achieve their professional goals.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pb-4">
              <div className="relative group">
                ...
                <Link
                  href="/careers"
                  className="relative inline-flex items-center px-8 py-4 bg-white text-blue-700 rounded-full font-semibold hover:bg-blue-50 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                >
                  View Open Positions
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div className="relative group">
                ...
                <a
                  ...
                  className="relative inline-flex items-center px-8 py-4 border-2 border-white text-white rounded-full font-semibold hover:bg-white hover:text-blue-700 transition-all duration-300 transform hover:scale-105"
                >
                  Contact Us
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
