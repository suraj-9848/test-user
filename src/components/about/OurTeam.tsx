                  ...
                  <div className="flex justify-center space-x-4">
                    {founder.socials.linkedin && (
                      <Link
                        ...
                        className="p-3 rounded-full bg-white/20 backdrop-blur-sm hover:bg-blue-600 text-white transition-all duration-300 hover:scale-110"
                      >
                        <svg
                          className="w-6 h-6"
                          fill="currentColor"
                    ...
                    {founder.socials.twitter &&
                      founder.socials.twitter !== "#" && (
                        <Link
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="p-3 rounded-full bg-white/20 backdrop-blur-sm hover:bg-sky-500 text-white transition-all duration-300 hover:scale-110"
                        >
                          <svg
                            className="w-6 h-6"
                            fill="currentColor"
              ...
              {bioParagraphs.map((paragraph, pIndex) => {
                ...
                if (paragraph.startsWith("→")) {
                  return (
                    <div
                      key={pIndex}
                      className="flex items-start bg-gray-50 p-3 rounded-lg hover:bg-blue-50 transition-colors duration-300"
                    >
                      <span className="text-blue-500 mr-3 text-lg flex-shrink-0 font-bold">
                        →
                      </span>
                ...
                if (
                  paragraph.toLowerCase().includes("and this is just year 1.")
                ) {
                  return (
                    <div key={pIndex} className="mt-6">
                      <div className="relative bg-gradient-to-r from-blue-600 to-indigo-700 p-6 rounded-lg shadow-lg overflow-hidden">
                        ...
                        <p className="text-center text-white font-bold text-lg relative z-10">
                          {paragraph}
                        </p>
                      </div>
                    </div>
