  ...
  return (
    <section className="relative py-16 pt-32 overflow-hidden bg-gradient-to-b from-indigo-50 via-white to-blue-50">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <svg
          className="absolute top-0 left-0 w-full h-auto opacity-[0.03]"
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <h1 className="text-4xl font-bold sm:text-5xl lg:text-6xl mb-6 leading-tight">
              ...
              <span className="relative inline-block mx-2">
                <span className="relative z-10 text-indigo-600 font-extrabold">
                  redefine
                </span>
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl lg:max-w-none backdrop-blur-sm">
              Nirudhyog bridges the gap between learning and career success
              through innovative training, personalized mentorship, and direct
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto lg:mx-0">
              {[
                ...
                <div
                  key={index}
                  className="group bg-white/80 backdrop-blur-md rounded-xl shadow-lg border border-indigo-50 p-4 text-center hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:bg-gradient-to-br hover:from-blue-50 hover:to-indigo-50"
                >
                  <div className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent mb-1">
                    <span>{stat.number}</span>
                    <span>{stat.suffix}</span>
                  </div>
                  <p className="text-gray-600 text-sm group-hover:text-indigo-600 transition-colors duration-300">
                    {stat.label}
                  </p>
                </div>
              ))}
              ...
              <div className="relative bg-white/90 backdrop-blur-md rounded-2xl overflow-hidden shadow-2xl border border-indigo-50 transform hover:scale-[1.02] transition-transform duration-300">
                ...
                <div className="pt-12 pb-6 px-6">
                  ...
                  <div className="mt-6 flex justify-between items-center">
                    <div>
                      <h3 className="font-semibold text-gray-900 bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">
                        Our Learning Approach
                      </h3>
                      <p className="text-sm text-gray-600">
                        Personalized, interactive & industry-focused
                      </p>
                    </div>
