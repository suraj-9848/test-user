  ...
  const alumni = [
    {
      ...
      quote:
        "Nirudhyog helped me build the technical and soft skills that made me stand out to recruiters.",
      year: "Class of 2023",
    },
    {
      name: "Rahul Patel",
      ...
      quote:
        "The specialized training in data science accelerated my career path and helped me land my dream job.",
      year: "Class of 2022",
    },
    {
      name: "Ananya Desai",
      ...
      quote:
        "The mentorship and career guidance I received were invaluable for my transition into product management.",
      year: "Class of 2023",
    },
    {
      name: "Vivek Kumar",
      ...
      quote:
        "The practical projects and industry-focused curriculum prepared me for real-world challenges.",
      year: "Class of 2021",
    },
  ];
      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
        ...
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-gray-700">
            Meet some of our outstanding alumni who have transformed their
            careers through Nirudhyog&apos;s programs.
          </p>
        </div>
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-gray-600">
            Join our growing network of successful professionals and build your
            career with us.
          </p>
        </div>
      </div>
