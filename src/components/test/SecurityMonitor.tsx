...
export default function SecurityMonitor({
    ...
    return (
        <div className="fixed bottom-4 right-4 bg-white rounded-lg shadow-lg border p-3 z-40 min-w-[200px]">
            <div className="space-y-2 text-sm">
                {/* Security Status */}
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <Shield
                            className={`h-4 w-4 mr-2 ${getSecurityStatusColor()}`}
                        />
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center">
                        <Eye
                            className={`h-4 w-4 mr-2 ${getCameraStatusColor()}`}
                        />
                        <span>Camera:</span>
                    </div>
