                                ...
                                <div className="p-6">
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                        <div className="flex items-center text-gray-600">
                                            ...
                                            <span>
                                                {formatDuration(test.durationInMinutes)}
                                            </span>
                                        </div>
                                        <div className="flex items-center text-gray-600">
                                        ...
                                        <div className="flex items-start">
                                            ...
                                            <div className="text-sm">
                                                ...
                                                <ul className="text-yellow-700 space-y-1">
                                                    ...
                                                    <li>
                                                        • Tab switching and copying are
                                                        monitored
                                                    </li>
                                                    <li>
                                                        • Auto-submit on violations or
                                                        browser close
                                                    </li>
                                                </ul>
                                            </div>
                    ...
                    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                        ...
                        <div className="space-y-3 text-sm text-gray-600 mb-6">
                            ...
                            <p>
                                ...
                                <span className="font-medium">
                                    {formatDuration(
                                        selectedTest.durationInMinutes
                                    )}
                                </span>
                            </p>
                            ...
                            <div className="bg-red-50 border border-red-200 rounded-lg p-3 mt-4">
                                ...
                                <ul className="text-red-700 text-xs space-y-1">
                                    <li>
                                        • The test will switch to full-screen
                                        mode
                                    </li>
                                    <li>
                                        • Your camera will be activated for
                                        monitoring
                                    </li>
                                    <li>• Tab switching will be tracked</li>
                                    <li>
                                        • The test will auto-submit if you close
                                        the browser
                                    </li>
