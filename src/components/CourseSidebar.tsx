...
const CourseSidebar = ({
  ...
  <>
    ...
    />
    <aside
      className={`fixed md:static top-0 left-0 h-full w-64 md:w-full bg-white md:bg-transparent z-40 md:z-0 border-r border-gray-200 transform ${
        open
          ? "translate-x-0"
          : "-translate-x-full"
      } md:translate-x-0 transition-transform duration-200 ease-in-out md:relative p-4 sm:p-6`}
      style={{ maxWidth: 280 }}
    >
      <button
      ...
      <nav className="space-y-2 sm:space-y-3">
        ...
        <a
          className="block py-1.5 sm:py-2 px-2 sm:px-3 active-link mt-2 sm:mt-4"
          href="#"
        >
          Explore All
        </a>
      ...
      <div className="mt-6 sm:mt-10 p-4 sm:p-5 bg-purple-50 rounded-xl relative overflow-hidden">
        ...
        />
        <h3 className="text-base sm:text-lg font-semibold text-purple-700 mb-1 sm:mb-2 relative z-10">
