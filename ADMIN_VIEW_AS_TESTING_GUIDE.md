...
console.log('Current view-as role:', localStorage.getItem('admin_view_as_role'));
```
...
// Check current view
const viewAsContext = window.__REACT_DEVTOOLS_GLOBAL_HOOK__?.renderers?.get(1)?.findFiberByHostInstance?.(document.querySelector('[data-testid="role-picker"]'));
