...
const maleFirstNames = [
  "Venkata", "Krishna", "Srinivas", "Rajesh", "Suresh", "Ramesh", "Mahesh", "Ganesh",
  "Naresh", "Harish", "Venkatesh", "Kiran", "Praveen", "Anil", "Mohan", "Ravi",
  "Chandra", "Bhaskar", "Kishore", "Pavan", "Vamsi", "Siva", "Jagadish", "Ashwin",
  "Prasad", "Gopi", "Vinod", "Murali", "Karthik", "Naveen", "Lokesh", "Hari",
  "Chaitanya", "Tarun", "Venkat", "Gopal", "Nikhil", "Rakesh", "Srikanth", "Dhananjay",
  "Venu", "Rohit", "Ajay", "Sunil", "Varun", "Prashanth", "Keshav", "Vikram",
  "Siddharth", "Rajasekhar", "Nithin", "Deepak", "Nithish", "Hemanth", "Akhil",
  "Vishnu", "Charan", "Sumanth", "Abhishek", "Nitin", "Rohith", "Darshan", "Mohan",
  "Uday", "Arun", "Vijay", "Naga", "Teja", "Srinath", "Venky", "Surya", "Prabhu",
  "Satish", "Raghu", "Shankar", "Chakri", "Kalyan", "Pradeep", "Shiva", "Srinu",
  "Dinesh", "Aravind", "Madhu", "Santhosh", "Bhanu", "Chaitu", "Murthy", "Eswar",
  "Goutham", "Jaswanth", "Lokanath", "Manoj", "Nagendra", "Omkar", "Prithvi", "Raju",
  "Sarath", "Tejeshwar", "Umashankar", "Veeresh", "Yashwanth", "Vignesh", "Ramakrishna",
  "Anand", "Babu", "Durga", "Eshanth", "Hemanth", "Satyam", "Sriman", "Sriram",
  "Gautam", "Lalith", "Nagesh", "Prudhvi", "Sairam"
];

// Telugu/AP/Telangana female first names
const femaleFirstNames = [
  "Lakshmi", "Priya", "Kavitha", "Priyanka", "Divya", "Swathi", "Sowmya", "Madhuri",
  "Deepika", "Sneha", "Keerthi", "Nithya", "Sindhu", "Lavanya", "Sravya", "Vyshnavi",
  "Sahithi", "Mounika", "Bhavya", "Harini", "Vani", "Sushma", "Pooja", "Rachana",
  "Jyothi", "Anitha", "Sailaja", "Gowri", "Padma", "Chitra", "Ramya", "Srilekha",
  "Manasa", "Sruthi", "Alekhya", "Bhavani", "Roshni", "Tejaswi", "Vaishnavi",
  "Varsha", "Archana", "Nandini", "Roja", "Aparna", "Sandhya", "Shruti", "Spandana",
  "Jhansi", "Shravani", "Saritha", "Swetha", "Chandana", "Pallavi", "Thanuja",
  "Shobha", "Pranitha", "Harshitha", "Madhavi", "Revathi", "Nikhitha", "Deepthi",
  "Ramani", "Tejaswini", "Bhargavi", "Keerthana", "Srividya", "Pranavi", "Pavani",
  "Anjali", "Sahaja", "Akshaya", "Anusha", "Bhavitha", "Pragna", "Samyuktha",
  "Sravanthi", "Srilatha", "Manvitha", "Hema", "Sowjanya", "Nikitha", "Preethi",
  "Haritha", "Swapna", "Kavya", "Ashwini", "Mythri", "Varsha", "Satya", "Sirisha",
  "Sushmitha", "Tanuja", "Uma", "Vijaya", "Yamini", "Aaradhya", "Bindu", "Chandrika",
  "Dhanalakshmi", "Ganga", "Indira", "Jayanthi", "Kamala", "Lalitha", "Meenakshi",
  "Nagalakshmi", "Saraswati", "Sudha", "Sunitha", "Tulasi", "Vimala", "Radhika"
];

// Telugu/AP/Telangana surnames 
const surnames = [
  "Reddy", "Naidu", "Rao", "Raju", "Chowdary", "Goud", "Sharma", "Varma", "Chari", 
  "Murthy", "Sastry", "Prasad", "Achari", "Acharya", "Dora", "Devarakonda", "Bujji",
  "Nandyala", "Kuchipudi", "Akkineni", "Daggubati", "Konidela", "Allu", "Nandamuri",
  "Ghattamaneni", "Tottempudi", "Deverakonda", "Vemulapati", "Chiranjeevi", "Ravipudi",
  "Singampalli", "Tenali", "Anumolu", "Tupakula", "Manchu", "Yarlagadda", "Panduranga", 
  "Pothineni", "Gottipati", "Gunturi", "Jonnalagadda", "Kommareddy", "Lingampally", 
  "Madiraju", "Nimmagadda", "Ogirala", "Pulijala", "Rachakonda", "Surampudi", "Talluri", 
  "Uppalapati", "Vadlamudi", "Yellamraju", "Maddukuri", "Mudunuri", "Nareddula",
  "Palaparthi", "Yellandu", "Bezawada", "Bhamidipati", "Doppalapudi", "Ganapathiraju",
  "Gudavalli", "Vemulakonda", "Yendamuri", "Nanduri", "Chilukuri", "Adavi", "Bandi",
  "Challa", "Cherukuri", "Edupuganti", "Gudimetla", "Jampala", "Kadiyala", "Kakarlapudi",
  "Kondaveeti", "Madala", "Nelakuditi", "Pedapudi", "Saripalli", "Tadepalli", "Veeramachineni",
  "Mokkapati", "Paritala", "Abburi", "Buchepalli", "Devineni"
];

// Extra Telugu name components to add variety
const prefixes = ["Sri", "Sai", "Naga", "Venkata", "Rama", "Surya", "Chandra", "Durga", "Siva", "Satya", "Maha", "Lakshmi"];
const middleNames = ["Bhavani", "Kumar", "Prasad", "Teja", "Lakshmi", "Devi", "Krishna", "Pavan", "Manoj", "Srinivas"];
...
const createFixedLeaderboardData = () => {
  ...
  const generateUniqueName = (index: number): string => {
    ...
    if (usedNames.has(name)) {
      ...
      const districts = ["Vizag", "Guntur", "Hyderabad", "Warangal", "Kurnool", "Nellore"];
  ...
  for (let i = 0; i < studentCount; i++) {
    ...
    let percentage;
    if (i < studentCount * 0.03) { // Top 3%
      percentage = 95 + ((i * 0.01) % 5); // 95-100%
    } else if (i < studentCount * 0.10) { // Next 7%
      percentage = 90 + ((i * 0.01) % 5); // 90-95%
    } else if (i < studentCount * 0.25) { // Next 15%
      percentage = 80 + ((i * 0.1) % 10); // 80-90%
    } else if (i < studentCount * 0.50) { // Next 25%
      percentage = 70 + ((i * 0.1) % 10); // 70-80%
    } else if (i < studentCount * 0.75) { // Next 25%
      percentage = 60 + ((i * 0.1) % 10); // 60-70%
    } else if (i < studentCount * 0.90) { // Next 15%
